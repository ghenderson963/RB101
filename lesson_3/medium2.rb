# 1. Predict how the object IDs will change in the code below.
def fun_with_ids
  a_outer = 42
  b_outer = "forty two"
  c_outer = [42]
  d_outer = c_outer[0]   # 42  this points to the first element of the c_outer array.
...
# 2. Predict the object IDs below.
def fun_with_ids
  a_outer = 42
  b_outer = "forty two"
  c_outer = [42]
...
# 3. Predict the outcome of the code below.
